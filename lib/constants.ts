// Brand colors (used where CSS vars aren't available)
...
// VAPI assistant ID (from env)
export const ASSISTANT_ID = process.env.NEXT_PUBLIC_ASSISTANT_ID!;

// ElevenLabs voice options for book conversations
...
// VAPI dashboard config (mirror these in the VAPI assistant settings)
...
// Clerk auth UI overrides (inline colors for Tailwind build)
